...
export const demoHubJobs: HubJob[] = [
  {
    ...
    status: "under_study",
    favorite: false,
    next_step: "Prep recruiter call",
    comment: "",
    deadline: "2026-09-12",
    follow_up_at: "2026-09-04",
    match_score: null,
    salary: "面议",
    tasks: [
      {
  ...
  },
  {
    ...
    status: "to_do",
    favorite: true,
    next_step: "Read JD again",
    comment: "Strong product-thinking example",
    deadline: "2026-08-30",
    match_score: null,
    salary: "23-50k·15薪",
    tasks: [
